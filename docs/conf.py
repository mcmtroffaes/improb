# -*- coding: utf-8 -*-
#
# improb documentation build configuration file, created by
# sphinx-quickstart on Thu Jul 22 10:33:19 2010.
#
...
intersphinx_mapping = {
    ...
    'cdd': ('http://pycddlib.readthedocs.org/en/latest/', None),
}
